...
use crate::triangle::{integrands::flux_artificial, system_builder::domain::Domain};
...
pub fn build(system_matrix: &mut DMatrix<f64>, domain: &Domain) -> Result<(), ()> {
    ...
    for (e1, e2) in interfaces.iter() {
        ...
        system_matrix[(left_p1, left_p1)] += flux_matrix_upper[(lo_p1, lo_p1)];
        system_matrix[(left_p1, left_p2)] += flux_matrix_upper[(lo_p1, lo_p2)];
        system_matrix[(left_p1, left_p3)] += flux_matrix_upper[(lo_p1, lo_p3)];

        system_matrix[(left_p2, left_p1)] += flux_matrix_upper[(lo_p2, lo_p1)];
        system_matrix[(left_p2, left_p2)] += flux_matrix_upper[(lo_p2, lo_p2)];
        system_matrix[(left_p2, left_p3)] += flux_matrix_upper[(lo_p2, lo_p3)];

        system_matrix[(left_p3, left_p1)] += flux_matrix_upper[(lo_p3, lo_p1)];
        system_matrix[(left_p3, left_p2)] += flux_matrix_upper[(lo_p3, lo_p2)];
        system_matrix[(left_p3, left_p3)] += flux_matrix_upper[(lo_p3, lo_p3)];

        /* Populating system_matrix upper right */
        system_matrix[(left_p1, right_p1)] -= flux_matrix_upper[(lo_p1, lo_p1)];
        system_matrix[(left_p1, right_p2)] -= flux_matrix_upper[(lo_p1, lo_p2)];
        system_matrix[(left_p1, right_p3)] -= flux_matrix_upper[(lo_p1, lo_p3)];

        system_matrix[(left_p2, right_p1)] -= flux_matrix_upper[(lo_p2, lo_p1)];
        system_matrix[(left_p2, right_p2)] -= flux_matrix_upper[(lo_p2, lo_p2)];
        system_matrix[(left_p2, right_p3)] -= flux_matrix_upper[(lo_p2, lo_p3)];

        system_matrix[(left_p3, right_p1)] -= flux_matrix_upper[(lo_p3, lo_p1)];
        system_matrix[(left_p3, right_p2)] -= flux_matrix_upper[(lo_p3, lo_p2)];
